...
<body>
    <form id="aside" action="register.do" method="POST">
        ...
        <table>
            ...
            <tr>
                <td style="text-align: right;"><label for="name">Surname:</label>
                </td>
                <td><input type="text" id=surname name="surname"
                           value="${user.surname}" /></td>
            </tr>
            <tr>
                <td style="text-align: right;"><label for="name">Date of birth:</label>
                </td>
                <td><input type="" id=dateOfBirth name="dateOfBirth"
            ...
            <tr>
                ...
                <td><input type="text" id="email" name="email"
                    value="${user.email}" /> <!-- <h:message  for="email" errorClass="invalid" />-->
                </td>
            </tr>
            <tr>
                <td style="text-align: right;"><label for="name">Address:</label>
                </td>
